...
export default function GoogleRatingBadge({ rating, profileUrl }: GoogleRatingBadgeProps) {
    ...
    return (
        <a
            ...
            className="inline-flex items-center gap-3 bg-white/5 border border-white/10 px-4 py-2.5 rounded-full hover:bg-white/10 transition-colors duration-300"
        >
            {/* Google "G" icon */}
            ...
            <GoogleStars rating={rating.score} size="sm" />
