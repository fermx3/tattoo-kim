                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="space-y-5">
                                ...
                                {/* Hours */}
                                <div className="flex gap-3 items-start">
                                    <span className="text-[#14b8a6] mt-0.5 flex-shrink-0"><ClockIcon /></span>
                                    <div className="text-sm space-y-1">
                                        <div className="flex gap-3">
                                            <span className="text-slate-500 font-light w-32 flex-shrink-0">{t('locations_hours_weekdays')}</span>
                                            <span className="text-slate-300">{location.hours.weekdays}</span>
                                        </div>
                                        <div className="flex gap-3">
                                            <span className="text-slate-500 font-light w-32 flex-shrink-0">{t('locations_hours_saturday')}</span>
                                            <span className="text-slate-300">{location.hours.saturday}</span>
                                        </div>
                                        <div className="flex gap-3">
                                            <span className="text-slate-500 font-light w-32 flex-shrink-0">{t('locations_hours_sunday')}</span>
                                            <span className="text-slate-300">{location.hours.sunday}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
